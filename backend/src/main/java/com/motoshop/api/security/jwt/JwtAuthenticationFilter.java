...
/**
 * Authenticates each request from the {@code Authorization: Bearer ...} header. The filter is
 * intentionally permissive: invalid or missing tokens are not rejected here — they simply leave the
 * security context empty, and {@link
 * org.springframework.security.web.access.ExceptionTranslationFilter} decides afterwards whether
 * the target endpoint required authentication.
 */
@Component
