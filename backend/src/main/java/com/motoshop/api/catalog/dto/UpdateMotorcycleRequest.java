...
/**
 * Partial update payload. Every field is optional; only the supplied ones are applied. Validation
 * kicks in only when a field is present, because Bean Validation skips null values on non-@NotNull
 * fields.
 */
@Schema(
    name = "UpdateMotorcycleRequest",
