...
public class Motorcycle {
    ...
    /**
     * Object key in MinIO. Null in Sprint 1, populated in Sprint 2 when
     * the image upload flow is wired up.
     */
    ...
    public Integer getPowerHp() { return powerHp; }
    public Integer getTorqueNm() { return torqueNm; }
    public Integer getTopSpeedKmh() { return topSpeedKmh; }
    public EngineType getEngineType() { return engineType; }
    public Cooling getCooling() { return cooling; }
    public Integer getWeightKg() { return weightKg; }
    public Integer getSeatHeightMm() { return seatHeightMm; }
    ...
    public void setPowerHp(Integer powerHp) { this.powerHp = powerHp; }
    public void setTorqueNm(Integer torqueNm) { this.torqueNm = torqueNm; }
    public void setTopSpeedKmh(Integer topSpeedKmh) { this.topSpeedKmh = topSpeedKmh; }
    ...
    public void setSeatHeightMm(Integer seatHeightMm) { this.seatHeightMm = seatHeightMm; }
    public void setFuelCapacityL(BigDecimal fuelCapacityL) { this.fuelCapacityL = fuelCapacityL; }
    public void setColor(String color) { this.color = color; }
    public void setCategory(Category category) { this.category = category; }
    public void setLicense(LicenseType license) { this.license = license; }
    public void setTransmission(Integer transmission) { this.transmission = transmission; }
    public void setAbs(Boolean abs) { this.abs = abs; }
    public void setTractionControl(Boolean tractionControl) { this.tractionControl = tractionControl; }
}